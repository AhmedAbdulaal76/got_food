...
class ThemeColors {
  ...
  static const primaryColorDark = Color.fromARGB(255, 29, 63, 49);
  static const primaryColorLight = Color(0xFF5C8D88);
  static const primaryColorBright = Color.fromARGB(255, 192, 211, 204);
